...
import edu.wm.cs.cs301.matthewcheng.gui.MazeFileWriter;
...
public class Wall {
     ...
     *            obscure
     */
    private Integer createColor(final int distance, final int cc) {
        ...
        switch (((d >> 3) ^ cc) % 6) {
        case 0:
            return MazePanel.getInt(rgbValue, RGB_DEF, RGB_DEF);
        case 1:
        	return MazePanel.getInt(RGB_DEF, RGB_DEF_GREEN, RGB_DEF);
        case 2:
        	return MazePanel.getInt(RGB_DEF, RGB_DEF, rgbValue);
        case 3:
        	return MazePanel.getInt(rgbValue, RGB_DEF_GREEN, RGB_DEF);
        case 4:
        	return MazePanel.getInt(RGB_DEF, RGB_DEF_GREEN, rgbValue);
        case 5:
        	return MazePanel.getInt(rgbValue, RGB_DEF, rgbValue);
        default:
        	return MazePanel.getInt(RGB_DEF, RGB_DEF, RGB_DEF);
        }
    }
